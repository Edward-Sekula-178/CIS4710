...
module DatapathPipelined (
	...
	always @(posedge clk)
		if (rst || f_fence)
			...
			x_state <= {sv2v_cast_32((x_branch ? 0 : decode_state[95-:32])), sv2v_cast_32((x_branch ? 0 : decode_state[63-:32])), sv2v_cast_32((x_branch ? 32'd4 : decode_state[31-:32])), sv2v_cast_20((x_branch ? 0 : d_imm_u)), sv2v_cast_32((x_branch ? 0 : d_imm_i_sext)), sv2v_cast_32((x_branch ? 0 : d_imm_s_sext)), sv2v_cast_32((x_branch ? 0 : d_imm_b_sext)), sv2v_cast_32((x_branch ? 0 : d_imm_j_sext)), sv2v_cast_32((wd_bypass_rs1 ? w_state[31-:32] : 0)), sv2v_cast_32((wd_bypass_rs2 ? w_state[31-:32] : 0)), sv2v_cast_8((x_branch ? 0 : d_ic)), sv2v_cast_7((x_branch ? 0 : d_insn_opcode))};
	wire [255:0] x_disasm;
	...
	reg illegal_insn = ((((x_state[14-:8] == ICIllegal) || (d_ic == ICIllegal)) || (m_state[7-:8] == ICIllegal)) || m_illegal_insn) || w_state[32];
	wire [4:0] m_rs2;
